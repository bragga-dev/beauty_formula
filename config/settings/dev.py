...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://postgres@localhost:5432/beauty_formula",
    )
}
...
AWS_S3_CUSTOM_DOMAIN = env("MINIO_PUBLIC_URL",
    default="localhost:9000/beauty_formula-media"
)

MEDIA_URL = (
    f"http://"
    f"{env('MINIO_PUBLIC_URL', default='localhost:9000/beauty_formula-media')}/"
)
